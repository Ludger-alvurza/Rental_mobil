                            ...
                            @foreach ($messageRatings as $rating)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" data-id-message="{{ $rating->id }}"
                                            data-name="{{ $rating->message }}" class="btn btn-danger btn-sm btn-hapus">
                                            <i class="fas fa-trash"></i>
                                        </button>
                                        <!-- Modal -->
                                        <div class="modal fade" id="editModal{{ $rating->id }}" tabindex="-1"
                                            aria-labelledby="editModalLabel{{ $rating->id }}" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="editModalLabel{{ $rating->id }}">Edit
                                                            Message Rating</h5>
