                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('no_plat') is-invalid @enderror"
                                value="{{ old('no_plat') }}" name="no_plat">
                            @error('no_plat')
                        ...
                        <div class="form-group">
                            ...
                            <select name="brand" class="form-control @error('brand') is-invalid @enderror">
                                ...
                                <option value="chevrolet" {{ old('brand') == 'chevrolet' ? 'selected' : '' }}>Chevrolet
                                </option>
                                <option value="nissan" {{ old('brand') == 'nissan' ? 'selected' : '' }}>Nissan</option>
                                <option value="volkswagen" {{ old('brand') == 'volkswagen' ? 'selected' : '' }}>Volkswagen
                                </option>
                                ...
                                <option value="mercedes" {{ old('brand') == 'mercedes' ? 'selected' : '' }}>Mercedes-Benz
                                </option>
                                ...
                                <option value="land_rover" {{ old('brand') == 'land_rover' ? 'selected' : '' }}>Land Rover
                                </option>
                                <option value="tesla" {{ old('brand') == 'tesla' ? 'selected' : '' }}>Tesla</option>
                                <option value="volvo" {{ old('brand') == 'volvo' ? 'selected' : '' }}>Volvo</option>
                                <option value="mitsubishi" {{ old('brand') == 'mitsubishi' ? 'selected' : '' }}>Mitsubishi
                                </option>
                                <option value="Lamborghini" {{ old('brand') == 'Lamborghini' ? 'selected' : '' }}>
                                    Lamborghini</option>
                                <option value="Ferrari" {{ old('brand') == 'Ferrari' ? 'selected' : '' }}>Ferrari</option>
                                <option value="MClaren" {{ old('brand') == 'MClaren' ? 'selected' : '' }}>MClaren</option>
                            </select>
                            @error('brand')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="price_per_day" class="form-control @error('price_per_day') is-invalid @enderror"
                                value="{{ old('price_per_day') }}" name="price_per_day">
                            @error('price_per_day')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="denda" class="form-control @error('denda') is-invalid @enderror"
                                value="{{ old('denda') }}" name="denda">
                            @error('denda')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="availability" name="availability"
                                ...
                                <option value="Tersedia" {{ old('availability') == 'Tersedia' ? 'selected' : '' }}>Tersedia
                                </option>
                                <option value="Sold Out" {{ old('availability') == 'Sold Out' ? 'selected' : '' }}>Tidak
                                    Tersedia</option>
                            </select>
                            @error('availability')
