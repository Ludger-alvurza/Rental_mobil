...
<nav class="navbar navbar-expand-lg blur blur-rounded z-index-3 shadow position-sticky my-3 py-2 start-0 end-0 mx-4" id="navbarBlur" navbar-scroll="true" style="top: 0;">
  <div class="container-fluid pe-0">
      ...
      <div class="collapse navbar-collapse" id="navigation">
          <ul class="navbar-nav mx-auto ms-xl-auto me-xl-7">
              <li class="nav-item">
                  <a class="nav-link d-flex align-items-center me-2 active" aria-current="page" href="{{ url('/sewa-mobil') }}">
              ...
              <li class="nav-item">
                  <a class="nav-link me-2" href="{{ url('user/change-password') }}">
