...
<body class="g-sidenav-show bg-gray-100 d-flex flex-column min-vh-100">
    ...
    <main class="main-content flex-grow-1">
        ...
        <div class="container-fluid py-6 mb-6">
            @yield('content')
        </div>
    </main>
    <footer class="footer bg-dark text-white py-4 fixed-bottom w-100">
        <div class="container text-center">
            <p>&copy; 2024 Aplikasi Rental Ukrim. All Rights Reserved.</p>
            <div>
