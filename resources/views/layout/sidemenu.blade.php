<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  ...
  <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav" style="margin-left: -10px;">
      ...
      @can('user')
      <li class="nav-item">
        <a class="nav-link  active" href="/sewa-mobil">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>shop </title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
@endauth
      ...
      <li class="nav-item">
        <a class="nav-link  " href="{{url('/mobil')}}">
          ...
          <span class="nav-link-text ms-1">List Mobil</span>
        </a>
      </li>
      <li class="nav-item">
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link  " href="{{url('/pesanan')}}">
          ...
          <span class="nav-link-text ms-1">Pemesanan Mobil</span>
        </a>
      </li>
      @can('superadmin')
      <li class="nav-item">
        <a class="nav-link  " href="{{url('/message_ratings')}}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">Message Rating User</span>
        </a>
      </li>
      @endcan
      <li class="nav-item">
        <a class="nav-link  " href="/itemtransactions">
          ...
          <span class="nav-link-text ms-1">Cek Denda</span>
        </a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link  " href="/transaksi">
          ...
          <span class="nav-link-text ms-1">Data Booking Mobil</span>
        </a>
      </li>
      @endcan
